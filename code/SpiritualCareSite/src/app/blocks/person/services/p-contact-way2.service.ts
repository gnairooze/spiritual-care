...
@Injectable()
export class PContactWay2Service {
  private getAllUrl = this.config.BaseURL + 'P_ContactWay2/GetP_ContactWay2';
  private getOneUrl = this.config.BaseURL + 'P_ContactWay2/GetP_ContactWay2';
  private addUrl = this.config.BaseURL + 'P_ContactWay2/PostP_ContactWay2';
  private updateUrl = this.config.BaseURL + 'P_ContactWay2/PutP_ContactWay2';
  private deleteUrl = this.config.BaseURL + 'P_ContactWay2/DeleteP_ContactWay2';
