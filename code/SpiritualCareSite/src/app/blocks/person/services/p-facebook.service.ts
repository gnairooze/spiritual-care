...
@Injectable()
export class PFacebookService {
  private getAllUrl = this.config.BaseURL + 'P_Facebook/GetP_Facebooks';
  private getOneUrl = this.config.BaseURL + 'P_Facebook/GetP_Facebook';
  private addUrl = this.config.BaseURL + 'P_Facebook/PostP_Facebook';
  private updateUrl = this.config.BaseURL + 'P_Facebook/PutP_Facebook';
  private deleteUrl = this.config.BaseURL + 'P_Facebook/DeleteP_Facebook';
